...
<head>
    ...
    <style>
        ...
        input:focus {
            border: 1px solid #f8b400; /* Highlight border on focus */
        }
        ...
        .btn:hover {
            background-color: #444444; /* Darken button on hover */
        }
    </style>
</head>
<body>
    ...
    <div class="container">
        <div class="image-header"></div> <!-- Header image -->
        <h2>Signup</h2>
        <form method="POST">
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO netflix_user (username, email, password) VALUES ('$username', '$email', '$password')";
